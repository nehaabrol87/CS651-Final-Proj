System.config({
  ...
  map: {
    "Reklino/angular-resizable": "github:Reklino/angular-resizable@1.2.0",
    ...
    "gulp-nodemon": "npm:gulp-nodemon@2.0.4",
    ...
    "npm:nodemon@1.8.1": {
      ...
      "path": "github:jspm/nodelibs-path@0.1.0",
      "process": "github:jspm/nodelibs-process@0.1.2",
      "ps-tree": "npm:ps-tree@1.0.1",
      "touch": "npm:touch@1.0.0",
      "undefsafe": "npm:undefsafe@0.0.3",
    ...
    "npm:update-notifier@0.5.0": {
      "chalk": "npm:chalk@1.1.1",
      "child_process": "github:jspm/nodelibs-child_process@0.1.0",
      "configstore": "npm:configstore@1.3.0",
